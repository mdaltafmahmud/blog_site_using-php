...
<div class="sidebar clear">
    <div class="samesidebar clear">
		...
		<ul>
			...
			?>		 
		    <li>
			   <a href="posts.php?catagory=<?php echo $result_catagory['id'];?>">
			    <?php echo $result_catagory['name'];?></a>
			</li>
			<?php }} ?>					
		</ul>
	</div>
	...
	<div class="samesidebar clear">
		    ...
		    <div class="popular clear">
			    <h3>
				   <a href="post.php?id=<?php echo $result_post['id'];?>">
			        <?php echo $result_post['title'];?></a>
			    </h3>
